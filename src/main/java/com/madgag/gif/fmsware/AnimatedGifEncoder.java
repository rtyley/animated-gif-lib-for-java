 ...
 * </pre>
 * 
 * No copyright asserted on the source code of this class. May be used for any purpose, however, refer to the Unisys LZW patent for restrictions on use of the
 * associated LZWEncoder class. Please forward any corrections to questions at fmsware.com.
 *
...
public class AnimatedGifEncoder {
    ...
    /**
     * Sets the transparent color for the last added frame and any subsequent frames. Since all colors are subject to modification in the quantization process,
     * the color in the final palette for each frame closest to the given color becomes the transparent color for that frame. If exactMatch is set to true,
     * transparent color index is search with exact match, and not looking for the closest one. May be set to null to indicate no transparent color.
     *
     * @param c
     *            Color to be treated as transparent on display.
     */
    ...
    /**
     * Sets the background color for the last added frame and any subsequent frames. Since all colors are subject to modification in the quantization process,
     * the color in the final palette for each frame closest to the given color becomes the background color for that frame. May be set to null to indicate no
